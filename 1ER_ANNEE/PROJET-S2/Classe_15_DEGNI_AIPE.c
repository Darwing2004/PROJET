...
void AffichageMain(const BigInt *A, const BigInt *B)
{
    printf("\nA=");
    printBigInt(A);
    printf("B=");
...
int main()
{
    const char *numberStrA = "9962815268583840000000";
    ...
    // Initialiser le BigInt à partir d'une chaine de caractères avec une base de 10
